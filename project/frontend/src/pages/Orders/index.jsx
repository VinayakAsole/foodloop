...
export const Orders = () => {
  ...
  }, [orders, user?.uid, activeChatOrderId, isChatOpen, user]);
      ...
      <div className="max-w-4xl mx-auto px-4 md:px-8 space-y-6">
        ...
        {activeTab === 'orders' && (
          loading ? (
            ...
            <div className="responsive-card p-16 text-center flex flex-col items-center justify-center">
              ...
              {activeOrders.length > 0 && (
                <section className="space-y-5">
                  ...
                  {activeOrders.map(order => {
                    ...
                    return (
                      <TiltCard key={order.id} className="responsive-card overflow-hidden shadow-xl shadow-primary-500/5">
                        ...
                        <div className="px-5 pt-5 pb-3 flex flex-col md:flex-row justify-between gap-3">
                          ...
                          <div className="text-right shrink-0 flex flex-col items-end">
                            ...
                            {!order.isDonation && (
                              <span className="inline-block mt-1 text-[8px] px-1.5 py-0.5 font-bold uppercase rounded bg-cyan-500/10 text-cyan-400 border border-cyan-500/20">
              ...
              {pastOrders.length > 0 && (
                <section className="space-y-4">
                  ...
                  {pastOrders.map(order => {
                    ...
                    return (
                      <TiltCard key={order.id} className={`responsive-card p-5 flex flex-col md:flex-row gap-5 ${
                        isCompleted ? 'border-emerald-500/20' : 'border-rose-500/20'
                      }`}>
                        <div className="flex-grow space-y-3">
                          <div className="flex items-start justify-between">
                            ...
                            <div className="text-right">
                              ...
                              {!order.isDonation && (
                                <span className="inline-block mt-0.5 text-[8px] px-1.5 py-0.5 font-bold uppercase rounded bg-cyan-500/10 text-cyan-400 border border-cyan-500/20">
                                  {order.paymentStatus || 'Paid'}
                                </span>
                              )}
                            </div>
          ...
          <div className="space-y-3">
            {notificationLogs.length > 0 ? (
              notificationLogs.map(log => (
                <div key={log.id} className="responsive-card p-4 flex gap-3">
